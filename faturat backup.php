                                ...
                                <table id="order-listing" data-ordering="false" class="table" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                         ...
                                         if (isset($_GET['kerko'])) {
                                           $d1 = $_GET['d1'];
                                           $d2 = $_GET['d2'];
                                           $kueri = $conn->query("SELECT * FROM fatura WHERE data >= '$d1' AND data <= '$d2' ORDER BY data");
                                         } else {
                                           $d1 = "0";
                                           $d2 = "0";
                                         ...
                                         ?>
                                           ...
                                           if ($qq4['sum'] > $merrep['sum']) {
                                                ?>
                                                  <tr>
                                                <th><?php echo $k4['emri']; ?></th>
                                                <td><?php echo $k4['emriart']; ?> - <small><?php echo $k4['nrllog']; ?></small></td>
