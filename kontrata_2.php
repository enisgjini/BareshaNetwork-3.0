                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <input type="text" name="numri_tel" id="numri_tel" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div>
                            ...
                            <textarea type="text" name="shenime" id="shenime" class="form-control"></textarea>
                        </div>
                    </div>
                    <br>

                    <canvas id="signatureCanvas" width="600" height="200"
                        class="border border-1 shadow-2 bg-white rounded"></canvas>
                        <br>
