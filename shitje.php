...
$mfid = $conn->query("SELECT * FROM fatura WHERE fatura='$fatura'");
...
if (isset($_POST['ruaj'])) {
  ...
  if ($conn->query("INSERT INTO shitje (emertimi, qmimi, perqindja, klientit, mbetja,totali, fatura, data) VALUES ('$emertimi', '$qmimi', '$perqindja', '$shm', '$shk', '$shm', '$fatura', '$datas')")) {
  } else {
...
if (isset($_POST['update'])) {
  ...
  if ($conn->query("UPDATE shitje SET emertimi='$eme', qmimi='$qmimi', klientit='$shm', mbetja='$shk', totali='$shm' WHERE id='$updateid'")) {
  } else {
    echo "Ndodhi nj&euml; gabim: " . $conn->error;
  }
}
  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="container">
        ...
        <form method="POST" action="shitje.php?fatura=<?php echo $fatura; ?>">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          $q = $conn->query("SELECT * FROM shitje WHERE fatura='$i'");
          ...
          <tr>
            ...
            <td></td>
            <?php
            $q4 = $conn->query("SELECT SUM(`totali`) as `sum` FROM `shitje` WHERE fatura='$fatura'");
      ...
      <br>
      <a href="faturat.php" class="btn btn-success float-right" target="_blank">D&euml;rgo</a>
