            ...
            <div class="row">
              <div class="col-12">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                  ...
                  <br>
                  <label for="pershk" class="form-label">P&euml;rshkrimi</label>
                  <textarea class="form-control shadow-sm" id="simpleMde" name="pershk"></textarea>
                  <br>
                  <button type="submit" name="ruaj" value="" class="btn btn-primary text-white"><i class='fi fi-rr-paper-plane'></i> &nbsp;&nbsp;Dergo</button>
                  <a href="index.php" class="btn btn-secondary text-white"><i class="fi fi-rr-cross-circle"></i>&nbsp;&nbsp;Anulo</a>
                </form>
              </div>
            </div>
          </div>
