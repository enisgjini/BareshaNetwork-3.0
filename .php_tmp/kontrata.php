...
<body>
    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <div class="content" id="content" style="width: 80%; margin: 10px auto;">
                ...
                <div class="card border border-1 p-3 shadow-2">
                    <div class="row">
                        <div class="col text-center">
                            <h3>Kontratë ne mes te artistit dhe Baresha Music</h3>
                            <p><i> Marrëveshja mes artistit dhe Baresha Music</i></p>
                        </div>
                    </div>
                    <div class="row gap-2">
                        <div class="col border rounded p-3 m-3">
                            <p><b>Emri & Mbiemri <small>(Name & Last Name)</small></b> : <?php echo $m2['emri']; ?></p>
                            <p><b>Emri Artistik <small>(Artistic name)</small></b> : <?php echo $m2['emriart']; ?></p>
                            <p><b>ID Dokumentit <small>(Document ID)</small></b> : <?php echo $m2['np']; ?></p>
                            <p><b>Adresa <small>(Address)</small></b> : <?php echo $m2['adresa']; ?></p>
                            <p><b>Numri telefonit <small>(Phone number)</small></b> : <?php echo $m2['nrtel']; ?></p>
                            <p><b>Adresa e email-it <small>(Email address)</small></b> : <?php echo $m2['emailadd']; ?></p>
                        </div>
                        <div class="col border rounded p-3 m-3">
                            <p><b>Data e kontratës :</b> <?php echo $m2['dk']; ?></p>
                            <p><b>Data e mbarimit :</b> <?php echo $m2['dks']; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border border-1 p-3 shadow-2">
                    <div class="row">
                        <div class="col text-center">
                            <h5>„Artist- Performues“ me te drejta komerciale dhe Baresha Music si “Përfaqësues i plotfuqishëm i te drejtave komerciale”. </h5>
                            <p><i> Performer with the commercial rights and Baresha Music as the legal representative of the commercial rights.
                                </i></p>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><b>1.</b></td>
                        <td>Objekti i Kontratës</td>
                        <td>The object of the contract</td>
                    </tr>
                    <tr>
                        <td><b>1.1</b></td>
                        <td>Vepra e realizuar audio - vizuale te cilat publikohen ne te gjitha platformat e internetit nga Baresha Music e njëjta i përdorë për fitime komerciale.</td>
                        <td>Audio and visual work which will be published on the all integrated platforms of the internet from Baresha Music, the same will be used for the commercial profits.</td>
                    </tr>
                    <tr>
                        <td><b>1.2</b></td>
                    ...
                    <tr>
                        <td><b>1.3</b></td>
                        <td>Baresha Music i merr nga Artisti-Pronari te gjitha te drejtat për përfaqësimin e veprave te komercializuara ne te gjitha platformat e internetit.</td>
                        <td>Baresha Music takes from the Owner all the rights for representation of the commercialised works in all platforms of the internet.</td>
                    </tr>
                    <tr>
                        <td><b>1.4</b></td>
                        <td>Baresha Music detyrohet qe veprat me te drejtën e transferuar për përfaqësim ti mbroj nga përdoruesit tjerë te paautorizuar si publikimet ne formatet e ndryshme ne internet.</td>
                        <td>Baresha Music is obligated that works with the transfered right for the represent to cover from the other unauthorised user such as publications in other formats in internet.</td>
                    </tr>
                    <tr>
                        <td><b>1.5</b></td>
                        <td>Artisti – Pronari garanton se veprat e transferuara për përfaqësim nuk janë dhënë palës se tretë ne te njëjtën kohë po ashtu nuk ka ndonjë kontratë te vlefshme me te, njëherit me nënshkrimin e Artistit – Pronarit garantohet qe nga krijuesit si kompozitoret, tekstshkruesit dhe studiot regjistruese janë marr pëlqimet për përdorimin e se drejtës komerciale.</td>
                        <td>Owner guarantees that the transfered work for the represent are not given to the third parties in the same time, also he hasn’t any valid contract with the third parties. Meanwhile the Owner guarantiees that the composer, lyricswriter and the records studio has been granted the permissions for the commercial rights.</td>
                    </tr>
                    <tr>
                        <td><b>1.6</b></td>
                        <td>
                            Pjesa e fitimit te Artistit-Pronarit prej <b><?php echo 100 - $m2['perqindja']; ?>%</b> do te i transferohet ne llogarinë e saj/tij komerciale dhe Artisti-Pronari është obligues për barazime tatimore ne shtetin ku jeton.
                        </td>
                        <td>The income portion of the Owner from <b><?php echo 100 - $m2['perqindja']; ?>%</b> will be transfer on his commercial Bank Account and the Owner is obligated to pay the income taxes of the Country where he/she lives.</td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><b>2.</b></td>
                        <td>Përmbledhja ligjore</td>
                        <td>The legal content
                        </td>
                    </tr>
                    <tr>
                        <td><b>2.1</b></td>
                        <td>Artisti-Pronari e transferon te drejtën e plotë komerciale gjatë gjithë kohës sa është kontrata ne fuqi per veprat e cekura ne aneksin 1.2 te kontrates.</td>
                        <td>The Owner is transfered the whole commercial right during the all the time as the contract is valid for the works described in the annex 1.2 of the contract.</td>
                    </tr>

                    <tr>
                        <td><b>2.2</b></td>
                        <td>Palët janë te vetëdijshëm qe ne përdorimin online te kësaj krijimtarie, e njëjta mund te shikohet ne te gjithë boten, përpos nëse artisti vendos qe mos ta shfaqë ne territore te caktuara.</td>
                        <td>Parties are aware that using online of this work, the same can be viewed in the whole world, except if the Owner decide his/her not to be shown in particualr countries.</td>
                    </tr>
                    <tr>
                        <td><b>2.3</b></td>
                        <td>Artisti pajtohet qe gjatë shfaqjeve online në te gjitha platformat e internetit do te vendosen materiale propaganduese / reklamuese pa dallim gjuhë apo figure (përpos materiale te cilat përmbajnë skena urrejtje, dhune, raciste etj.).</td>
                        <td>The Owner agrees that during online tune in all platforms of internet will be shown other commercial/propagandistic content, no matter what language(except if materials containing hate sceenes, racism or violence sceenes, etc).</td>
                    </tr>
                    <tr>
                        <td><b>3.1</b></td>
                        <td><?php
                            ...
                            ?>
                            Kohëzgjatja e kësaj kontrate është <?php echo $totalMonths; ?> muaj nga data e nënshkrimit nga te dy palët. Kontrata zgjatet ne mënyrë automatike. </td>
                        <td>Duration of this contract is set for <?php echo $totalMonths; ?> Months from the signing date from the both parties. The contract will be extended automaticlly.</td>
                    </tr>
                    <tr>
                        <td><b>3.2</b></td>
                        <td>
                            Shkëputja e kontratës mund te behet me pajtimin e palëve duke e njoftuar Baresha Music 1 muaj para skadimit te kontratës.

                        </td>
                        <td>The termination of the contract can be done with agreement of both parties informing Baresha Music one Month in advance from the date of the contract expire.
                        </td>
                    </tr>
                    <tr>
                        <td><b>3.3</b></td>
                        ...
                        <td>Baresha Music has the right to terminate the contract unilateral in case the performer violates the agreements set and based on this the Baresha Music has the right to request the compensation from the performer.
                        </td>
                    </tr>
                    <tr>
                        <td><b>3.4</b></td>
                        ...
                        <td>Performer has the right to terminate the contract unilateraly on writen form in case Baresha Music does not accomplish the payments mentioned in 1.5 section within one month following next month.
                        </td>
                    </tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Mbrojtja e te dhënave</td>
                        <td>Data protection</td>
                    </tr>
                    <tr>
                        <td>Performuesi pranon që të dhënat e tij personale si emri, mbiemri, adresa, numri i telefonit, emaili, mund të përdoren për arsye regjistrimi në regjistrimet e skedarëve nga Baresha Music, ndërsa emri artistik mund të publikohet në të gjitha platformat e internetit.</td>
                        <td>Performer agrees that his/her personal data such as name, surname, address, phone number, email, can be used for registration reason to the file records from the Baresha Music, whereas the artistic name can be published in all platforms of the internet.</td>
                    </tr>
                    <tr>
                        <td>Palët obligohet qe te përdorin kodin e sekretit mbi marrëveshjen ne këtë kontrate.</td>
                        <td>Parties are obligated to use the secret over the agreement in this contract.</td>
                    </tr>

                    <tr>
                        <td>Marrëveshjet plotësuese ne mes te palëve mund te behën vetëm me shkrim.</td>
