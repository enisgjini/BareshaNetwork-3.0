    ...
    <div id="page-container">
        ...
        <div class="content" id="content" style="width: 95%; margin: 10px auto;">
            ...
            <div class="card border border-1 p-3 shadow-2">
                <div class="row">
                    <div class="col text-center">
                        <h5>„Artist- Performues“ me te drejta komerciale dhe Baresha Music si “Përfaqësues i
                            plotfuqishëm i te drejtave komerciale”. </h5>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>Vepra e realizuar audio - vizuale te cilat publikohen ne te gjitha platformat e internetit
                        nga Baresha Music e njëjta i përdorë për fitime komerciale.</td>
                ...
                <tr>
                    <td><b>1.3</b></td>
                    <td>Baresha Music i merr nga Artisti-Pronari te gjitha te drejtat për përfaqësimin e veprave te
                ...
                <tr>
                    <td><b>1.4</b></td>
                    <td>Baresha Music detyrohet qe veprat me te drejtën e transferuar për përfaqësim ti mbroj nga
                        përdoruesit tjerë te paautorizuar si publikimet ne formatet e ndryshme ne internet.</td>
                ...
                <tr>
                    <td><b>1.5</b></td>
                    <td>Artisti – Pronari garanton se veprat e transferuara për përfaqësim nuk janë dhënë palës se
                        tretë ne te njëjtën kohë po ashtu nuk ka ndonjë kontratë te vlefshme me te, njëherit me
                        nënshkrimin e Artistit – Pronarit garantohet qe nga krijuesit si kompozitoret,
                        tekstshkruesit dhe studiot regjistruese janë marr pëlqimet për përdorimin e se drejtës
                        komerciale.</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        </b> do te i transferohet ne llogarinë e saj/tij komerciale dhe Artisti-Pronari është
                        obligues për barazime tatimore ne shtetin ku jeton.
                    </td>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td><b>2.1</b></td>
                    <td>Artisti-Pronari e transferon te drejtën e plotë komerciale gjatë gjithë kohës sa është
                ...
                <tr>
                    <td><b>2.2</b></td>
                    <td>Palët janë te vetëdijshëm qe ne përdorimin online te kësaj krijimtarie, e njëjta mund te
                        shikohet ne te gjithë boten, përpos nëse artisti vendos qe mos ta shfaqë ne territore te
                        caktuara.</td>
                ...
                <tr>
                    <td><b>2.3</b></td>
                    <td>Artisti pajtohet qe gjatë shfaqjeve online në te gjitha platformat e internetit do te
                        vendosen materiale propaganduese / reklamuese pa dallim gjuhë apo figure (përpos materiale
                        te cilat përmbajnë skena urrejtje, dhune, raciste etj.).</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        Kohëzgjatja e kësaj kontrate është
                        <?php echo $totalMonths; ?> muaj nga data e nënshkrimit nga te dy palët. Kontrata zgjatet ne
                        mënyrë automatike.
                    </td>
                ...
                <tr>
                    <td><b>3.2</b></td>
                    <td>
                        Shkëputja e kontratës mund te behet me pajtimin e palëve duke e njoftuar Baresha Music 1
                        muaj para skadimit te kontratës.
                ...
                <tr>
                    <td><b>3.3</b></td>
                    <td>
                        Baresha Music ka te drejt ta shkëput kontratën njëanshëm ne rast se Artisti-Përformuesi i
                        shkel marrëveshjet e përmendura dhe me këtë Baresha Music ka te drejte ti kërkoj
                        dëmshpërblim.
                    </td>
                ...
                <tr>
                    <td><b>3.4</b></td>
                    <td>
                        Artistit-Përformuesit ka te drejt shkëputjen e njëanshme me shkrim ne rast se Baresha Music
                        nuk e bënë pjesën e pagesës te cekur ne 1.5 brenda afatit 1 mujor ne muajin pasues.
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>Performuesi pranon që të dhënat e tij personale si emri, mbiemri, adresa, numri i telefonit,
                        emaili, mund të përdoren për arsye regjistrimi në regjistrimet e skedarëve nga Baresha
                        Music, ndërsa emri artistik mund të publikohet në të gjitha platformat e internetit.</td>
