        ...
        <div class="card my-2 py-5 px-3 mb-4">
          ...
          <form method="GET" action="" class="form-inline">
            <div class="form-group row">
              <div class="col-6">
                Prej :
                <input type="date" class="form-control w-100" value="<?php echo date("Y-m-d"); ?>" style="width: 230px;"
                  name="d1" autocomplete="off">
              </div>
              <div class="col-6">
                Deri :
                <input type="date" class="form-control w-100" value="<?php echo date("Y-m-d"); ?>" style="width: 230px;"
                  name="d2" autocomplete="off">
              </div>
              <div class="col my-3">
                    ...
                    <tbody>
                      ...
                      while ($k = mysqli_fetch_array($merri)) {
                        ...
                        <tr>
                          ...
                          <td> <a class="btn btn-light shadow-2 border border-1" target="_blank"
                              href="fatura.php?invoice=<?php echo $k['fatura']; ?>"><i class="fi fi-rr-print"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
...
<script>
  $('#example').DataTable({
    ...
    buttons: [{
      ...
      title: "Pagesat e kryera gjate periudhes <?php $d1; ?> - <?php echo $d2; ?> ne formatin PDF"
    }, {
      extend: 'copyHtml5',
      ...
      className: 'btn btn-light border shadow-2 me-2',
      filename: 'Pagesat e kryera gjate:  <?php echo $d1; ?> - <?php echo $d2; ?>',
      title: "Pagesat e kryera gjate periudhes <?php $d1; ?> - <?php echo $d2; ?> ne formatin Excel"
    }, {
      extend: 'print',
      ...
      className: 'btn btn-light border shadow-2 me-2',
      filename: 'Pagesat e kryera gjate:  <?php echo $d1; ?> - <?php echo $d2; ?>',
      title: "Pagesat e kryera gjate periudhes <?php $d1; ?> - <?php echo $d2; ?>"
    }],
    ...
    stripeClasses: ['stripe-color'], "processing": true,
    "order": [],
  })
</script>