  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    <ul class="navbar-nav mr-lg-4 w-100">
      ...
      <li class="nav-item dropdown me-1">
        <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center" id="theme-dropdown" href="#" data-bs-toggle="dropdown">
          <span id="toggle-icon" class="fi fi-rr-moon-stars"></span>
        </a>
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
          <a class="dropdown-item">
            <button class="dropdown-item" id="system-theme">Use System Theme</button>
          </a>
          <a class="dropdown-item">
            <button class="dropdown-item" id="light-theme"><i class="fi fi-rr-brightness"></i> Light Theme</button>
          </a>
          <a class="dropdown-item">
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item">
        ...
        <a type="button" class="btn btn-light btn-sm " data-bs-toggle="modal" data-bs-target="#exampleModal">
