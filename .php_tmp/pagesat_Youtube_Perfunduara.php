        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="">
                    ...
                    <input type="text" name="fatura" class="form-control" value="<?php echo date('dmYhis'); ?>"
                        readonly>
                ...
                <div class="p-5 bg-light mb-4 card">
                    ...
                    <nav class="d-flex">
                        <h6 class="mb-0">
                            ...
                            <span>/</span>
                            <a href="faturat.php" class="text-reset" data-bs-placement="top" data-bs-toggle="tooltip"
                                title="<?php echo __FILE__; ?>"><u>Pagesat Youtube</u></a>
                        </h6>
                    </nav>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="modal fade" id="pagesmodal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="user_form">
                                                <label>Fatura:</label>
                                                <input type="text" name="fatura" id="fatura" class="form-control"
                                                    value="" placeholder="Shëno numrin e faturës">
                                                <label>P&euml;rshkrimi:</label>
                                                <textarea class="form-control" name="pershkrimi"
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="shuma" id="shuma" class="form-control"
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Hiqe</button>
                                            <input type="button" name="ruajp" id="btnruaj" class="btn btn-primary"
                                                value="Ruaj">
                                            </form>
                                        </div>
                                    </div>
