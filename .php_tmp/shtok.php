      ...
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col">
            ...
            <select class="form-select w-100" name="ads" id="js-example-basic-single w-100">
        ...
        <div class="form-group row">
          <div class="col">
            ...
            <textarea id="simpleMde" name="info" placeholder="Info Shtes&euml;" class="form-control"></textarea>
          </div>
        </div>
    </div>
    <br>
