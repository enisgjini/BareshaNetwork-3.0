                                ...
                                <table class="table table-borderless report-table">
                                  <tr>
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        ...
                                        echo ($janarRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $janarRezultatiShitjeve['sum']; ?>"
                                          aria-valuemin="??php echo $min; ??" aria-valuemin="??php echo $min; ??"
                                          aria-valuemin="<?php echo $min; ?>" aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        <div class="progress-bar bg-warning" role="progressbar"
                                          style="width: <?php echo ($shkurtRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $shkurtRezultatiShitjeve['sum']; ?>"
                                          aria-valuemin="??php echo $min; ??" aria-valuemin="??php echo $min; ??"
                                          aria-valuemin="<?php echo $min; ?>" aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        <div class="progress-bar bg-danger" role="progressbar"
                                          style="width: <?php echo ($marsRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $marsRezultatiShitjeve['sum']; ?>" aria-valuemin="0"
                                          aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    <td>
                                      <h5 class="font-weight-bold mb-0">
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        <div class="progress-bar bg-primary" role="progressbar"
                                          style="width: <?php echo ($prillRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $prillRezultatiShitjeve['sum']; ?>"
                                          aria-valuemin="0" aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    <td>
                                      <h5 class="font-weight-bold mb-0">
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        <div class="progress-bar bg-success" role="progressbar"
                                          style="width: <?php echo ($majRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $majRezultatiShitjeve['sum']; ?>" aria-valuemin="0"
                                          aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    ...
                                    <td class="w-100 px-0">
                                      <div class="progress progress-md mx-4">
                                        <div class="progress-bar bg-danger" role="progressbar"
                                          style="width: <?php echo ($qershorRezultatiShitjeve['sum'] * 100) / $max; ?>%"
                                          aria-valuenow="<?php echo $qershorRezultatiShitjeve['sum']; ?>"
                                          aria-valuemin="0" aria-valuemax="<?php echo $max; ?>"></div>
                                      </div>
                                    </td>
                                    <td>
