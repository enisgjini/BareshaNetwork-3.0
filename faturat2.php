...
<!-- Modal -->
<div class="modal fade" id="shtochannel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
        ...
        <div class="p-5 bg-light mb-4 card">
          ...
          <nav class="d-flex">
            <h6 class="mb-0">
              ...
              <span>/</span>
              <a href="faturat2.php" class="text-reset" data-bs-placement="top" data-bs-toggle="tooltip"
                title="<?php echo __FILE__; ?>"><u>Platformat tjera</u></a>
            </h6>
          </nav>
        </div>
